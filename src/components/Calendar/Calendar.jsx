...
<S.Calendar>
			...
			<S.CalendarBlock>
				...
				<S.CalendarContent>
					<S.CalendarDays>
						<S.CalendarDay>пн</S.CalendarDay>
						<S.CalendarDay>вт</S.CalendarDay>
						<S.CalendarDay>ср</S.CalendarDay>
						<S.CalendarDay>чт</S.CalendarDay>
						<S.CalendarDay>пт</S.CalendarDay>
						<S.CalendarDay className="-weekend-">сб</S.CalendarDay>
						<S.CalendarDay className="-weekend-">вс</S.CalendarDay>
					</S.CalendarDays>
					<S.CalendarSells>
				...
				<S.CalendarPeriod>
					<S.CalendarP className="date-end">Срок исполнения: <span>09.09.23</span></S.CalendarP>
				</S.CalendarPeriod>
			</S.CalendarBlock>
		</S.Calendar>
    )
